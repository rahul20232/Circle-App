...
class EventAlertController {
  ...
  EventAlertController({required this.onStateChanged});
  ...
  Future<void> _loadSettings() async {
    ...
    try {
      ...
      if (userPrefs != null) {
        ...
        _pushNotifications = user.eventPushNotifications;
        _sms = user.eventSms;
        _email = user.eventEmail;
      }
    } catch (e) {
  ...
  Future<void> saveSettings(BuildContext context) async {
    try {
      await ApiService.updateUserPreferences(
        eventPushNotifications: _pushNotifications,
        eventSms: _sms,
        eventEmail: _email,
      );
