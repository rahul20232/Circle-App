...
Revision ID: b3896400703b
Revises: d03881528237
Create Date: 2025-09-01 18:26:31.662761
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('children_status', sa.String(), nullable=True))
